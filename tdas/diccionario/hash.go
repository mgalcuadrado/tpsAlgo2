...
func (hash *hashCerrado[K, V]) Iterador() IterDiccionario[K, V] {
	...
	iterador.hash = hash
	iterador.indiceDelSiguiente(true)
	return iterador
}
...
func (iterador *iterHashCerrado[K, V]) Siguiente() {
	iterador.verificarSiguiente()
	iterador.indiceDelSiguiente(false)
}
...
// indiceDelSiguiente es una función interna que devuelve el índice en el que está el siguiente elemento válido.
func (iterador *iterHashCerrado[K, V]) indiceDelSiguiente(inicio bool) {
	if !inicio {
